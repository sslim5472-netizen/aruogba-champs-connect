      ...
      <div className="container mx-auto px-4 py-12">
        ...
        <div className="text-center mb-12 animate-fade-in">
          ...
          <p className="text-muted-foreground">
            Players with the most red cards in the tournament
          </p>
        </div>
        ...
        <div className="max-w-3xl mx-auto animate-scale-in">
          <div className="glass-card p-6 rounded-xl">
            {loading ? (
              ...
              <div className="text-center text-muted-foreground py-12">No top red cards available yet.</div>
            ) : (
              <div className="space-y-3">
                {topRedCards.map((player, index) => (
                  ...
                  >
                    ...
                    <div className="text-3xl font-heading text-red-600">{player.red_cards}</div>
                  </div>
                ))}
              </div>
            )}
